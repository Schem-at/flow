...
const nodeTemplates: NodeTemplate[] = [
  ...
  },
  {
    ...
    label: 'Form',
    Icon: FormInput,
    description: 'Dense multi-field input form (one node, many fields)',
    color: 'text-indigo-300',
    bg: 'bg-indigo-500/10',
    keywords: ['form', 'input', 'fields', 'inputs', 'dense', 'params', 'parameters', 'group inputs'],
    config: { fields: [{ name: 'a', dataType: 'number', widgetType: 'number', value: 0 }], bundle: { enabled: false, name: 'values' } },
  },
  {
    type: 'inspect',
    label: 'Inspect',
